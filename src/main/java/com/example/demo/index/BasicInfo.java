...
public class BasicInfo {
    ...
    public BasicInfo(String name, int age, long identification, String gender, Date date, String namePinyin,
                     int mrRaw, int mrSort, int mrDate, String remarkForFollowupVisit, int csvdNum,
                     String primDiag, int followupYear, int dropOut, long hospitalNum, long bedNum,
                     long clinicNum, Date birthDate, String ethnic, String eduLevel, int eduYear,
                     String profession, String work, String address, long contact, String specimenRemark,
                     String blood, int bloodBox, int bloodSampleNum, int cerebrospinalFluidNum,
                     int urineNum, String medicalHistory, int memoryDeclineCourse,
                     int increasedMemoryImpairment, String maritalStatus, int height, int weight,
                     String cerebrovascularDisease, int cerebrovascularDiseaseYear,
                     String stableCerebrovascularDisease, String cerebrovascularDiseaseMedication,
                     String cnsDiseaseDescription, String hypertension, String hypertensionYear,
                     String highestHypertension, String averageHypertension, String stableHypertension,
                     String hypertensionMedication, String diabetes, int diabetesYear,
                     String stableDiabetes, String diabetesMedication, String coronaryDisease,
                     int coronaryDiseaseYear, String stableCoronaryDisease, String atrialFibrillation,
                     int atrialFibrillationYear, String atrialFibrillationControl, String hyperlipidemia,
                     int hyperlipidemiaYear, String stableHyperlipidemia, String hyperlipidemiaMedication,
                     String medicalRemark, String otherMedicine, String smoke, int smokeYear, int smokeNumPerDay, String quitSmoking,
                     int quitSmokingYear, String drink, int historyOfAlcoholism, int alcoholGPerDay, String quitDrinking,
                     int quitDrinkingYear, String familyHistory, String familyHistoryDiscription) {
        this.name = name;
        this.age = age;
