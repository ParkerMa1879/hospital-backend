    ...
    public ResponseEntity<BasicInfo> createBasicInfo(@RequestBody BasicInfo basicInfo) {
        try {
            BasicInfo _basicInfo = basicInfoRepository
                    .save(new BasicInfo(basicInfo.getName(),basicInfo.getAge(),
                            basicInfo.getIdentification(),basicInfo.getGender(),basicInfo.getDate(),
                            basicInfo.getNamePinyin(),basicInfo.getMrRaw(),basicInfo.getMrSort(),basicInfo.getMrDate(),
                            basicInfo.getRemarkForFollowupVisit(),basicInfo.getCsvdNum(),basicInfo.getPrimDiag(),
                            basicInfo.getFollowupYear(),basicInfo.getDropOut(),basicInfo.getHospitalNum(),
                            basicInfo.getBedNum(),basicInfo.getClinicNum(),basicInfo.getBirthDate(),
                            basicInfo.getEthnic(),basicInfo.getEduLevel(),basicInfo.getEduYear(),
                            basicInfo.getProfession(),basicInfo.getWork(),basicInfo.getAddress(),
                            basicInfo.getContact(),basicInfo.getSpecimenRemark(),basicInfo.getBlood(),
                            basicInfo.getBloodBox(),basicInfo.getBloodSampleNum(),basicInfo.getCerebrospinalFluidNum(),
                            basicInfo.getUrineNum(),basicInfo.getMedicalHistory(),basicInfo.getMemoryDeclineCourse(),
                            ...
                            basicInfo.getHypertension(),basicInfo.getHypertensionYear(),
                            basicInfo.getHighestHypertension(),basicInfo.getAverageHypertension(),
                            basicInfo.getStableHypertension(),basicInfo.getHypertensionMedication(),
                            basicInfo.getDiabetes(),basicInfo.getDiabetesYear(),basicInfo.getStableDiabetes(),
                            basicInfo.getDiabetesMedication(),basicInfo.getCoronaryDisease(),
                            ...
                            basicInfo.getHyperlipidemiaMedication(),basicInfo.getMedicalRemark(),
                            basicInfo.getOtherMedicine(),basicInfo.getSmoke(),basicInfo.getSmokeYear(),
                            basicInfo.getSmokeNumPerDay(),basicInfo.getQuitSmoking(),
